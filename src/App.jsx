...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Interaction handlers to ensure play if browser initially restricted un-gestured autoplay
        ...
        <header className="border-b border-white/20 bg-black/25 backdrop-blur-md sticky top-0 z-50 shadow-lg">
          <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3.5">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-black via-slate-900 to-[#DFB15B] p-0.5 shadow-lg shadow-black/40 flex items-center justify-center">
                <div className="w-full h-full bg-black/80 backdrop-blur-md rounded-[14px] flex items-center justify-center text-[#DFB15B]">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M19 9V14C19 15.6569 17.6569 17 16 17H8C6.34315 17 5 15.6569 5 14V9" stroke="#DFB15B" strokeWidth="2" strokeLinecap="round" />
                    <path d="M7 5C7 3.89543 7.89543 3 9 3H15C16.1046 3 17 3.89543 17 5V13H7V5Z" fill="#DFB15B" fillOpacity="0.3" stroke="#DFB15B" strokeWidth="2" />
                    <path d="M4 11H5V15H4C3.44772 15 3 14.5523 3 14V12C3 11.4477 3.44772 11 4 11Z" fill="#DFB15B" />
                    <path d="M20 11H19V15H20C20.5523 15 21 14.5523 21 14V12C21 11.4477 20.5523 11 20 11Z" fill="#DFB15B" />
                    <path d="M7 17V20M17 17V20" stroke="#DFB15B" strokeWidth="2" strokeLinecap="round" />
                  </svg>
                </div>
              </div>
              <div>
                ...
                <p className="text-[11px] sm:text-xs font-bold text-white/80 drop-shadow-xs">Fair Seat Allocation</p>
              </div>
            </div>
